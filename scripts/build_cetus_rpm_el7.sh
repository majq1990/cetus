...
rm -rf ~/rpmbuild/RPMS/x86_64/cetus-${version_no}-${release_no}.el7.x86_64.rpm
rm -rf ~/rpmbuild/RPMS/x86_64/cetus-debuginfo-${version_no}-${release_no}.el7.x86_64.rpm
rm -rf ~/rpmbuild/SRPMS/cetus-${version_no}-${release_no}.el7.src.rpm
...
cd $basedir
mv ~/rpmbuild/RPMS/x86_64/cetus-${version_no}-${release_no}.el7.x86_64.rpm ./
mv ~/rpmbuild/RPMS/x86_64/cetus-debuginfo-${version_no}-${release_no}.el7.x86_64.rpm ./
mv ~/rpmbuild/SRPMS/cetus-${version_no}-${release_no}.el7.src.rpm ./
