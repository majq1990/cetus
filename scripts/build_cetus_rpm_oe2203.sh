...
rm -rf ~/rpmbuild/RPMS/x86_64/cetus-${version_no}-${release_no}.oe2203.x86_64.rpm
rm -rf ~/rpmbuild/RPMS/x86_64/cetus-debuginfo-${version_no}-${release_no}.oe2203.x86_64.rpm
rm -rf ~/rpmbuild/SRPMS/cetus-${version_no}-${release_no}.oe2203.src.rpm
...
cd ~
rpmbuild --define "debug_package %{nil}" --define 'dist .oe2203' -ba ~/rpmbuild/SPECS/cetus-${version_no}.spec

cd $basedir
mv ~/rpmbuild/RPMS/x86_64/cetus-${version_no}-${release_no}.oe2203.x86_64.rpm ./
#mv ~/rpmbuild/RPMS/x86_64/cetus-debuginfo-${version_no}-${release_no}.oe2203.x86_64.rpm ./
mv ~/rpmbuild/SRPMS/cetus-${version_no}-${release_no}.oe2203.src.rpm ./
